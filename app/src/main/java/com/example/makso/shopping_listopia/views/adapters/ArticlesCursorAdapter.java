...
public class ArticlesCursorAdapter extends CursorAdapter{
    ...
    public View newView(Context context, Cursor cursor, ViewGroup parent) {
        ...
        viewHolder.articleNameIndex   =   cursor.getColumnIndexOrThrow(Article.COLUMN_NAME);
    ...
    public void bindView(View view, final Context context, final Cursor cursor) {
        ...
        viewHolder.articleName.setText(cursor.getString(viewHolder.articleNameIndex));
        viewHolder.amount.setText(cursor.getString(viewHolder.amountIndex));
        Log.d("shoppingList", "Ime " + viewHolder.articleName.getText().toString());
